...
/*
    CONDICIONALES
*/
if(4 === 8){ // AL SER FALSO, NO SE EJECUTA LO DE LAS LLAVES. SI ES VERDADERO SÍ SE EJECUTA
...
if (hours <= 12) {
    ...
    switch("mike"){
        ...
        case "mike":
            ...
            break
            default:
                console.log("No encontre nunguna coincidencia")
    }

    /*Generar una evaluacion con idiomas 
*/

const language = prompt('What is your language (Spanish, German,English?');
...
//1. INICIALICIACION CON QUE NUMERO QUIERO EMPEZAR
// 2. CONDICION
//3. INCREMENTABLE DE LA INICIALIZACION
